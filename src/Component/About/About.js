  ...
  return (
    <div>
      ...
      <div className="container mx-auto py-10 px-3">
        <div>
          <h2 className="about-heading text-center text-4xl font-medium">
            OUR VOLUNTEERS
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  gap-4 mt-20 mx-auto">
          {volunterrs.map((volunterr) => (
            <Volunteer key={volunterr.name} volunterr={volunterr}></Volunteer>
          ))}
        </div>
      </div>
        ...
        <div className="container mx-auto p-3">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  gap-4  mx-auto">
            {counters.map((counter) => (
              <Counter key={counter.name} counter={counter}></Counter>
            ))}
          </div>
        </div>
      </div>
